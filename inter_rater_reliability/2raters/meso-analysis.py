...
def format_data(data, output_path, detailed_path):
    new_dict_meso = {}
    new_dict_high = {}
    for key, value in data.items():
        ...
        output_data(new_dict_meso, new_dict_high, output_path, detailed_path)

def output_data(new_dict_meso, new_dict_high, output_path, detailed_path):
    meso_folder = f"{output_path}/meso/{detailed_path}"
    high_folder = f"{output_path}/high/{detailed_path}"
...
round_number = "round2"
# detailed_path = "leica-luna"
# detailed_path = "luna-nina"
detailed_path = "isha-luna"
input_file = f"{round_number}/{detailed_path}/qualified.json"
output_file = f"meso-{round_number}"
data = load_file(input_file)

format_data(data, output_file, detailed_path)
