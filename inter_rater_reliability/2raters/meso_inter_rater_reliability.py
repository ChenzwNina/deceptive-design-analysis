...
labels = ["roach-motel", "creating-barriers", "adding-steps", "bait-and-switch", "hiding-information", "contextualizing", "manipulating-choice", "bad-defaults", "emotional", "trick-questions", "choice-overload", "hidden-info", "language-inaccessibility", "feedward-ambiguity", "nagging", "forced-continuity", "forced-registration", "forced-communication", "gamification", "attention-capture", "scarcity", "social-proof", "urgency", "confirmshaming"]
...
folder_name = "meso"
round = 3
with open(f"meso-round{round}/{folder_name}/hanyu-luna/qualified.json", encoding="utf-8") as fh:
